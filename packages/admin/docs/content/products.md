...
| `type`             | string   | yes      | The type of product                                                          |
...
| `weight_unit`      | string   | no       | The weight unit of the product                                               |
| `weight_value`     | float    | no       | The weight value of the product                                              |
| `height_unit`      | string   | no       | The height unit of the product                                               |
| `height_value`     | float    | no       | The height value of the product                                              |
| `width_unit`       | string   | no       | The width unit of the product                                                |
| `width_value`      | float    | no       | The width value of the product                                               |
| `depth_unit`       | string   | no       | The depth unit of the product                                                |
| `depth_value`      | float    | no       | The depth value of the product                                               |
| `volume_unit`      | string   | no       | The volume unit of the product                                               |
| `volume_value`     | float    | no       | The volume value of the product                                              |
| `brand_id`         | bigint   | no       | Nullable                                                                     |
