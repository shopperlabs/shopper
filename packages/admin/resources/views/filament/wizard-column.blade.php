...
>
    ...
    <div class="h-full xl:grid xl:grid-cols-4 xl:gap-x-12">
        <ol
            ...
            @foreach ($getChildComponentContainer()->getComponents() as $step)
                ...
                >
                    ...
                    @if (! $loop->last)
                        <div
                            aria-hidden="true"
                            class="fi-fo-wizard-header-step-separator absolute end-0 hidden h-full w-5 md:block xl:hidden"
                        >
                            <svg
                                fill="none"
        ...
        <div class="flex flex-col justify-between py-6 lg:max-w-6xl xl:col-span-3 xl:px-20">
            <div class="flex-1">
                @foreach ($getChildComponentContainer()->getComponents() as $step)
                    {{ $step }}
                @endforeach
