<x-shopper::layouts.setting :title="__('shopper::pages/settings.mailable.title_template')">
    ...
    <x-shopper::breadcrumb :back="route('shopper.settings.mails.select-template')">
        ...
        <x-shopper::breadcrumb.link :link="route('shopper.settings.mails.select-template')" :title="__('shopper::pages/settings.mailable.templates')" />
        ...
        <form action="{{ route('shopper.settings.mails.store-template') }}" method="POST">
            ...
            <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                <div class="sm:col-span-3">
                    <label for="content" class="sr-only">{{ __('shopper::layout.forms.label.content') }}</label>
