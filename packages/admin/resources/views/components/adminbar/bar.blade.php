    ...
    >
        <div class="h-full max-h-full p-1 duration-300 ease-out">
            <div class="w-8 rounded-md bg-gray-950/90 pb-1 backdrop-blur-xl dark:bg-gray-50/90">
                <div class="group flex size-8 items-center justify-center overflow-hidden">
                    <button
                        :class="{ 'translate-x-full' : iframeOpen }"
                        x-on:click="barOpen=false"
                        class="flex size-8 items-center justify-center duration-300 ease-out"
                    >
                        <svg
                            class="relative size-4 shrink-0 opacity-60 duration-300 ease-out group-hover:opacity-100"
                            viewBox="0 0 24 24"
                            fill="none"
                        ...
                        >
                            <path
                                d="M3.74963 12H20.2496M3.74963 12L10.2496 18.25M3.74963 12L10.2496 5.75"
                                stroke="currentColor"
                                stroke-width="2"
                    ...
                    <button
                        :class="{ '-translate-x-full' : !iframeOpen }"
                        x-on:click="iframeOpen=false"
                        class="absolute flex size-8 items-center justify-center duration-300 ease-out"
                    >
                        <svg
                            class="relative size-4 shrink-0 opacity-60 duration-300 ease-out group-hover:opacity-100"
                            fill="none"
                ...
                <a
                    ...
                    target="_blank"
                    class="group relative text-white/70 hover:text-white dark:text-gray-950/60 dark:hover:text-gray-950"
                >
                    <span
                        class="relative z-20 flex size-8 items-center justify-center from-gray-950 to-gray-800 group-hover:bg-gradient-to-r dark:group-hover:bg-gradient-to-r dark:group-hover:from-gray-50 dark:group-hover:to-white"
                    >
                        <x-phosphor-notebook-duotone
                            class="size-4 text-white duration-300 ease-out group-hover:translate-x-0.5"
                            aria-hidden="true"
                        />
                    </span>
                    <span
                ...
                <button
                    x-on:click="
                        iframeURL = '{{ route('shopper.dashboard') }}'
                        iframeOpen = ! (section == 'admin' && iframeOpen)
                        section = 'admin'
                    "
                    :class="{
                ...
                >
                    ...
                    >
                        <x-shopper::brand
                            class="size-4 duration-300 ease-out group-hover:translate-x-0.5"
                            aria-hidden="true"
                        />
                    </span>
                    <span
