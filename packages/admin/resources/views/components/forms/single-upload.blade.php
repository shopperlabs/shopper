...
<div x-data="{ focused: false }">
    ...
    @else
        <label for="{{ $attributes['id'] }}" :class="{ 'border-primary-200 bg-primary-50 dark:bg-gray-800': focused }" class="mt-2 group flex justify-center border-2 border-gray-300 dark:border-gray-600 border-dashed hover:border-primary-200 dark:hover:border-gray-600 hover:bg-primary-50 dark:hover:bg-gray-700 rounded-md cursor-pointer overflow-hidden">
            ...
            <div class="w-full h-32 bg-gray-50 dark:bg-gray-700 p-6 flex items-center justify-center" wire:loading.class.remove="hidden" wire:target="file">
