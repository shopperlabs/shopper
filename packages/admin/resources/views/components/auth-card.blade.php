<div class="relative isolate flex items-center justify-center min-h-screen">
    <svg class="absolute inset-0 -z-10 hidden h-full w-full stroke-secondary-200 dark:stroke-secondary-900 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)] sm:block" aria-hidden="true">
        <defs>
