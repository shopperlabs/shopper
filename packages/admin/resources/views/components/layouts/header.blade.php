<div
    class="sh-header sticky top-0 z-20 flex h-16 shrink-0 border-b border-gray-200 bg-gray-50 lg:h-auto lg:py-2 dark:border-white/10 dark:bg-gray-950 lg:rounded-tl-xl"
>
    <button
    ...
    @if (\Shopper\Sidebar\sidebar_is_collapsible())
        ...
        >
            <svg class="size-6 text-gray-400 dark:text-gray-500" viewBox="0 0 24 24" stroke="currentColor" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.74902 6.75C2.74902 5.09315 4.09217 3.75 5.74902 3.75H18.2507C19.9075 3.75 21.2507 5.09315 21.2507 6.75V17.25C21.2507 18.9069 19.9075 20.25 18.2507 20.25H5.74902C4.09217 20.25 2.74902 18.9069 2.74902 17.25V6.75Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
