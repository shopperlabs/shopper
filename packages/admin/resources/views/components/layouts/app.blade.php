<x-shopper::layouts.base :title="$title ?? null" class="overflow-hidden bg-secondary-50">
    ...
    <div class="h-screen flex overflow-hidden" x-data="{ sidebarOpen: false, modalDemo: false }" @keydown.window.escape="sidebarOpen = false">
        ...
        <div class="flex flex-col w-0 flex-1 lg:pb-1.5 lg:my-2 overflow-hidden bg-white ring-1 ring-secondary-200 dark:bg-secondary-950 dark:ring-secondary-800 lg:rounded-tl-2xl lg:rounded-bl-2xl">
