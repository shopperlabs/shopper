<div class="sticky top-0 z-40 shrink-0 flex h-16 bg-white dark:bg-secondary-900 lg:py-4 lg:h-auto border-b border-secondary-200 dark:border-secondary-700">
    ...
    <div class="flex-1 px-4 lg:px-6 flex items-center justify-between">
        ...
        <div class="ml-4 flex items-center space-x-3 lg:ml-6 lg:space-x-4">
            ...
            >
                <button @click="show = !show" type="button" class="inline-flex items-center space-x-2 p-1 text-secondary-500 text-sm leading-5 dark:text-secondary-300 hover:text-secondary-700 dark:hover:text-secondary-300 ring-1 ring-secondary-200 dark:ring-secondary-700 rounded-lg hover:bg-secondary-50 dark:hover:bg-secondary-800">
            ...
            <a href="{{ url('/') }}" target="_blank" class="hidden lg:inline-flex items-center p-1 text-secondary-500 hover:text-secondary-700 dark:text-secondary-400 dark:hover:text-white ring-1 ring-secondary-200 dark:ring-secondary-700 rounded-lg hover:bg-secondary-50 dark:hover:bg-secondary-800">
