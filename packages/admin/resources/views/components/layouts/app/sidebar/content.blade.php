<div {{ $attributes->merge(['class' => 'bg-secondary-50 dark:bg-secondary-800 border-r border-transparent md:border-secondary-200 md:dark:border-secondary-700']) }}>
    <div class="flex flex-col h-full">
        <div class="px-4 py-5 bg-gradient-to-b from-secondary-200 dark:from-secondary-900">
            <div class="flex items-start">
                <a class="shrink-0" href="{{ route('shopper.dashboard') }}">
                    <x-shopper::brand class="h-8 w-auto" />
                </a>
                <div class="ml-3 truncate">
                    <h4 class="text-base leading-4 font-bold text-secondary-900 dark:text-white truncate">
                        {{ config('app.name') }}
                    </h4>
                ...
                @can('access_setting')
                    <a
                        ...
                        @class([
                            ...
                            'bg-secondary-200 dark:bg-secondary-700 text-secondary-700 dark:text-white' => request()->routeIs('shopper.settings*'),
