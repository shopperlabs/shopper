    ...
    <main class="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-20 lg:px-8">
        ...
        <form wire:submit="store" class="divide-y divide-secondary-200 dark:divide-secondary-800">
            <div class="py-10">
                ...
                <div class="mt-8 lg:pl-12">
                    <x-shopper::card class="space-y-6 p-4 lg:p-6">
                        <x-shopper::forms.group :label="__('shopper::layout.forms.label.store_name')" for="name" isRequired>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <x-untitledui-shop class="w-5 h-5 text-secondary-400 dark:text-secondary-500" />
                                </div>
                                <x-shopper::forms.input id="name" type="text" wire:model="shop_name" class="pl-10" autocomplete="name" autofocus required />
                            </div>
                        </x-shopper::forms.group>
                        <x-shopper::forms.group :label="__('shopper::layout.forms.label.email')" for="email" isRequired>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            ...
            <div class="py-10">
                ...
                <div class="mt-8 lg:pl-12">
                    <x-shopper::card class="space-y-6 p-4 lg:p-6">
                        <x-shopper::forms.group :label="__('shopper::layout.forms.label.street_address')" for="street_address" isRequired>
                        ...
                        <x-shopper::forms.group :label="__('shopper::layout.forms.label.postal_code')" for="zipcode" isRequired>
                            <x-shopper::forms.input wire:model.defer="shop_zipcode" id="zipcode" type="text" autocomplete="off" placeholder="00237" required />
                        </x-shopper::forms.group>

                        <x-shopper::forms.group :label="__('shopper::layout.forms.label.city')" for="city" isRequired>
                        ...
                        <div wire:ignore x-data="internationalNumber('#phone_number')">
                            ...
                            <div class="mt-1">
                                <div class="relative sm:max-w-xs lg:max-w-lg">
