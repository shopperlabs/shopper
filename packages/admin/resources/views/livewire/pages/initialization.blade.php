<div class="min-h-screen lg:grid lg:grid-cols-5 lg:gap-x-20">
    ...
    <div class="min-h-full hidden px-1 pt-1.5 lg:flex lg:col-span-2">
        <div class="relative pt-32 pl-32 flex flex-1 overflow-hidden bg-secondary-50 rounded-tr-2xl rounded-br-2xl dark:bg-secondary-800">
            <svg class="absolute inset-0 z-10 h-full w-full stroke-secondary-200 dark:stroke-secondary-900 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)]" aria-hidden="true">
                <defs>
                    <pattern id="55d3d46d-692e-45f2-becd-d8bdc9344f45" width="250" height="250" x="50%" y="0" patternUnits="userSpaceOnUse">
                        <path d="M.5 200V.5H200" fill="none" />
                    </pattern>
                </defs>
                <svg x="50%" y="0" class="overflow-visible fill-secondary-50 dark:fill-secondary-900">
            ...
            <div class="relative flex rounded-tl-2xl shadow-xl h-full w-full z-20 bg-white dark:bg-secondary-950">
                <div class="p-8">
                    <x-shopper::brand class="h-10 w-auto" />
                </div>
                <div class="border-l border-secondary-100 pl-4 flex-1 divide-y divide-secondary-100 dark:divide-secondary-700 dark:border-secondary-700">
                    <div class="py-8 px-5">
                        <h2 class="text-xl font-heading font-bold text-secondary-900 dark:text-white">
                    ...
                    <div class="py-8 px-5 space-y-16">
                        <div class="flex items-center space-x-3">
                            <x-untitledui-home-line
                                ...
                                aria-hidden="true"
                            />
                            <span class="h-3.5 w-1/2 bg-secondary-100 rounded-full animate-pulse dark:bg-secondary-800"></span>
                        </div>
                        <div>
                            <h5 class="text-xs leading-5 text-secondary-500 dark:text-secondary-400 uppercase tracking-wider font-medium">
                            ...
                            <ul class="mt-5 space-y-8">
                                @foreach(range(0, 8) as $value)
                                    <li class="flex items-center space-x-2 animate-pulse">
                                        <div class="h-3 w-3 bg-secondary-100 rounded-full dark:bg-secondary-800"></div>
                                        <span class="h-3 w-1/2 bg-secondary-100 rounded-full dark:bg-secondary-800"
