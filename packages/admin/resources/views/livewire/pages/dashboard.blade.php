<x-shopper::container>
    <div class="flex items-center">
        <h2 class="welcome font-heading text-3xl leading-8 font-bold text-gray-900 dark:text-white sm:leading-9 sm:truncate">
            {!! __('shopper::messages.dashboard.welcome_message') !!}
        </h2>
    </div>

    <div class="my-8 bg-white border border-gray-200 dark:border-gray-700 dark:bg-gray-800 overflow-hidden rounded-lg">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 grid grid-cols-1 lg:grid-cols-2">
            <div class="p-6 space-y-5">
                <div class="flex items-center">
                    ...
                    <h4 class="ml-4 font-heading text-lg text-gray-900 leading-6 font-semibold dark:text-white">
            ...
            <div class="p-6 space-y-5 border-t border-gray-200 dark:border-gray-600 sm:border-t-0">
                <div class="flex items-center">
                    <div class="flex items-center justify-center h-10 w-10 bg-primary-100 dark:bg-primary-800/20 rounded-lg">
            ...
            <div class="p-6 space-y-5 border-t border-gray-200 dark:border-gray-600">
                <div class="flex items-center">
                    <div class="flex items-center justify-center h-10 w-10 bg-primary-100 dark:bg-primary-800/20 rounded-lg">
