            ...
            <div class="relative">
                <div class="flex items-center justify-between">
                    ...
                    <div x-data="{ display: false }">
                        ...
                        <div x-cloak x-show="display" @click.outside="display = false" class="absolute z-30 top-0 inset-x-0 p-4 mr-5 rounded-lg bg-gray-50 border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                            <div class="flex">
                                <div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 py-5">
                        <div class="sm:col-span-1">
                            <x-shopper::forms.group :label="__('shopper::layout.forms.label.sku')" for="sku" :error="$errors->first('sku')">
                                <x-shopper::forms.input wire:model.defer="sku" id="sku" type="text" class="dark:bg-gray-800" autocomplete="off" />
                            </x-shopper::forms.group>
                        </div>
                        <div class="sm:col-span-1">
        ...
        <div class="lg:col-span-2">
            <aside class="space-y-5">
                        ...
                        <div class="mt-4 px-3 py-2.5 bg-primary-500 bg-opacity-10 rounded-md text-primary-600 flex items-center justify-between">
                            ...
                            <div>
                                <span wire:model="isVisible"
                                      ...
                                      class="relative inline-flex shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer focus:outline-none focus:shadow-outline-primary bg-gray-200">
                ...
                <x-shopper::card>
                    ...
                    <div class="px-4 py-3">
                        <div class="space-y-3 p-2 max-h-96 border border-dashed border-gray-200 rounded-lg shadow-sm overflow-scroll hide-scroll dark:border-gray-700">
                                    ...
                                    <div class="relative flex justify-between">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 text-sm">
                                                <label for="category-{{ $category->id }}" class="font-medium text-gray-700 dark:text-gray-300">
                                                    {{ $category->name }}
                                                </label>
                                            </div>
                                        </div>
