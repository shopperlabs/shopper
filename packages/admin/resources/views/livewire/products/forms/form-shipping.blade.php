                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 sm:gap-y-4">
                        <x-shopper::forms.group class="sm:col-span-1" :label="__('shopper::layout.forms.label.width')">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center">
                                <x-shopper::forms.select wire:model.defer="WidthUnit" aria-label="{{ __('shopper::layout.forms.label.width_unit') }}" class="py-0 pl-2 pr-7 border-y-gray-300 dark:bg-gray-800">
                        ...
                        <x-shopper::forms.group class="sm:col-span-1" :label="__('shopper::layout.forms.label.height')">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center">
                                <x-shopper::forms.select wire:model.defer="heightUnit" aria-label="{{ __('shopper::layout.forms.label.height_unit') }}" class="py-0 pl-2 pr-7 border-y-gray-300 dark:bg-gray-800">
                                    <option value="cm">{{ __('shopper::words.unity.cm') }}</option>
                                    <option value="m">{{ __('shopper::words.unity.m') }}</option>
                                </x-shopper::forms.select>
                            </div>
                        ...
                        <x-shopper::forms.group class="sm:col-span-1" :label="__('shopper::layout.forms.label.weight')">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center">
                                <x-shopper::forms.select wire:model.defer="weightUnit" aria-label="{{ __('shopper::layout.forms.label.weight_unit') }}" class="py-0 pl-2 pr-7 border-y-gray-300 dark:bg-gray-800">
                        ...
                        <x-shopper::forms.group class="sm:col-span-1" :label="__('shopper::layout.forms.label.volume')">
                            <x-shopper::forms.input wire:model.defer="volumeValue" id="VolumeValue" type="text" class="block w-full pl-3 pr-12 dark:bg-gray-800" placeholder="0" />
                            <div class="absolute inset-y-0 right-0 flex items-center">
                                <x-shopper::forms.select wire:model.defer="VolumeUnit" aria-label="{{ __('shopper::layout.forms.label.volume_unit') }}" class="py-0 pl-2 pr-7 border-y-gray-300 dark:bg-gray-800">
