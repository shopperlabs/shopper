<x-shopper::container>
    ...
    <div class="mt-10 sm:mt-0">
        <div class="lg:grid lg:grid-cols-3 lg:gap-y-6 lg:gap-x-12">
            <div class="lg:col-span-1">
                <h3 class="mt-2 text-lg font-semibold leading-6 text-gray-900 dark:text-white font-heading">
                ...
                <div class="divide-y divide-gray-200 dark:divide-gray-700">
                    <div class="pb-5">
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            >
                                <x-shopper::forms.input wire:model.defer="sku" id="sku" class="dark:bg-gray-800 dark:border-transparent" type="text" autocomplete="off" />
                            </x-shopper::forms.group>
                            <x-shopper::forms.group
                            ...
                            >
                                <x-shopper::forms.input wire:model.defer="barcode" id="barcode" class="dark:bg-gray-800 dark:border-transparent" type="text" autocomplete="off" />
                            </x-shopper::forms.group>
                        </div>
                    ...
                    <div class="pt-5">
                        ...
                        <x-shopper::card class="mt-4 divide-y divide-gray-200 dark:divide-gray-700 overflow-hidden">
                            <div class="grid grid-cols-3 px-4 py-2 bg-gray-50 dark:bg-gray-700">
                                <div class="col-span-2">
                                    <span class="text-xs font-semibold leading-5 tracking-wider uppercase text-gray-500 dark:text-gray-400">
