    ...
    <div class="mt-8 lg:grid lg:grid-cols-3 lg:gap-6">
        <div class="lg:col-span-1">
            <div class="px-4 sm:px-0">
                ...
                <h3 class="mt-2 text-lg font-bold leading-6 text-secondary-900 dark:text-white font-display">
        ...
        <div class="mt-5 lg:mt-0 lg:col-span-2">
            <div class="shadow rounded-lg bg-white dark:bg-secondary-800 ring-1 ring-secondary-200 dark:ring-secondary-700">
                <div class="px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-3 gap-6">
                        <x-shopper::forms.group for="google_tracking_id" :label="__('shopper::layout.forms.label.ga_tracking_id')" class="col-span-3">
                            <x-shopper::forms.input wire:model.defer="google_analytics_tracking_id" type="text" id="google_tracking_id" placeholder="UA-XXX" />
                        </x-shopper::forms.group>
                        <x-shopper::forms.group for="google_view_id" :label="__('shopper::layout.forms.label.ga_view_id')" class="col-span-3">
                            <x-shopper::forms.input wire:model.defer="google_analytics_view_id" type="text" id="google_view_id" placeholder="123456789" />
                        </x-shopper::forms.group>
                        <x-shopper::forms.group for="analytic_script" :label="__('shopper::layout.forms.label.ga_additional_script')" class="col-span-3">
                            <x-shopper::forms.textarea wire:model.defer="google_analytics_add_js" id="analytic_script" />
                        </x-shopper::forms.group>
                    </div>
