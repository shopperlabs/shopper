<div class="flex items-center space-x-3 lg:pl-2">
    ...
    <div class="flex items-center">
        @if($category->getFirstMediaUrl(config('shopper.core.storage.collection_name')))
            <img class="h-8 w-8 rounded object-cover object-center" src="{{ $category->getFirstMediaUrl(config('shopper.core.storage.collection_name'))}}" alt="" />
        @else
