<div class="flex rounded-md shadow-sm">
    <input
        ...
        type="text"
        @class([
            'block w-full border-gray-300 shadow-sm transition duration-150 ease-in-out sm:text-sm sm:leading-5 dark:bg-gray-700 dark:text-white dark:border-gray-600',
            'rounded-none rounded-l-md focus:ring-0 focus:border-gray-300' => isset($columnSearch[$field]) && strlen($columnSearch[$field]),
