<div x-data="{ dropdownOpen: false }">
    <div class="relative flex items-center rounded-lg group transition ease-in-out duration-200">
        <button
            ...
            class="relative inline-flex items-center w-full text-sm leading-5 rounded-full focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-secondary-800"
            type="button">
        ...
        <div x-show="dropdownOpen"
             ...
             x-cloak
             class="absolute z-50 top-10 right-0 w-56 origin-top-right rounded-lg backdrop-blur-sm bg-white/60 shadow-lg ring-1 ring-secondary-200 dark:bg-secondary-900/80 dark:ring-secondary-800"
             x-ref="items"
             role="menu"
        ...
        >
            <div class="divide-y divide-secondary-100 dark:divide-secondary-700">
                <p class="truncate px-3.5 py-3">
                    <span class="block text-xs text-secondary-500 dark:text-secondary-400" role="none">
                        {{ __('shopper::words.sign_in_as') }}
                    </span>
                    <span class="mt-0.5 text-sm font-medium text-secondary-900 dark:text-white" role="none">
                        {{ $user->email }}
                    </span>
                </p>
                <div class="py-1.5">
