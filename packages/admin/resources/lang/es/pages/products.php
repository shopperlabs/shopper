...
return [
    ...
    'import' => [
        ...
        'description' => 'Elija la fuente desde la que desea importar sus productos.',
        'next' => 'Siguiente',
        'csv_title' => 'Importar productos desde un archivo CSV',
        'file' => 'Archivo CSV',
        'file_helper' => 'El archivo debe coincidir con la plantilla de importación de productos.',
        'download_template' => 'Descargar un archivo de ejemplo',
        'submit' => 'Importar productos',
        'not_mapped' => 'Sin asignar',
        'mapping_description' => 'Asocie las columnas de su archivo con los campos del producto. Las variantes, opciones e imágenes se detectan automáticamente.',
        'steps' => [
            'upload' => 'Archivo',
            'mapping' => 'Columnas',
            'review' => 'Revisión',
        ...
        'review' => [
            ...
            'unnamed' => '{1} :count producto sin nombre será omitido.|[2,*] :count productos sin nombre serán omitidos.',
            'more' => 'Y :count productos más…',
        ],
        'progress' => [
            'running' => 'Importación en curso…',
            'count' => ':imported de :total productos importados.',
        ],
        'started' => [
            'title' => 'Importación iniciada',
            'body' => 'Sus productos se están importando en segundo plano. Se le notificará cuando termine.',
        ],
    ],
];
