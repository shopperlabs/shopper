...
return [
    ...
    'import' => [
        ...
        'description' => 'Choose the source you want to import your products from.',
        'next' => 'Next',
        'csv_title' => 'Import products from a CSV file',
        'file' => 'CSV file',
        'file_helper' => 'The file must match the product import template.',
        'download_template' => 'Download a sample file',
        'submit' => 'Import products',
        'not_mapped' => 'Not mapped',
        'mapping_description' => 'Match the columns of your file with the product fields. Variants, options and images are detected automatically.',
        'steps' => [
            'upload' => 'Upload',
            'mapping' => 'Columns',
            'review' => 'Review',
        ...
        'review' => [
            ...
            'variants' => 'Variants',
            'stock' => 'Stock units',
            'unnamed' => '{1} :count product has no name and will be skipped.|[2,*] :count products have no name and will be skipped.',
            'more' => 'And :count more products…',
        ],
        'progress' => [
            'running' => 'Import in progress…',
            'count' => ':imported of :total products imported.',
        ],
        'started' => [
            'title' => 'Import started',
            'body' => 'Your products are being imported in the background. You will be notified when it finishes.',
        ],
    ],
];
