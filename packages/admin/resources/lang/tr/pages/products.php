...
return [
    ...
    'import' => [
        ...
        'description' => 'Ürünlerinizi içe aktarmak istediğiniz kaynağı seçin.',
        'next' => 'İleri',
        'csv_title' => 'CSV dosyasından ürünleri içe aktar',
        'file' => 'CSV dosyası',
        'file_helper' => 'Dosya, ürün içe aktarma şablonuyla eşleşmelidir.',
        'download_template' => 'Örnek dosya indir',
        'submit' => 'Ürünleri içe aktar',
        'not_mapped' => 'Eşlenmedi',
        'mapping_description' => 'Dosyanızın sütunlarını ürün alanlarıyla eşleştirin. Varyantlar, seçenekler ve görseller otomatik olarak algılanır.',
        'steps' => [
            'upload' => 'Dosya',
            'mapping' => 'Sütunlar',
            'review' => 'İnceleme',
        ...
        'review' => [
            ...
            'variants' => 'Varyantlar',
            'stock' => 'Stok adedi',
            'unnamed' => '{1} :count adsız ürün atlanacak.|[2,*] :count adsız ürün atlanacak.',
            'more' => 'Ve :count ürün daha…',
        ],
        'progress' => [
            'running' => 'İçe aktarma devam ediyor…',
            'count' => ':total üründen :imported tanesi içe aktarıldı.',
        ],
        'started' => [
            'title' => 'İçe aktarma başladı',
            'body' => 'Ürünleriniz arka planda içe aktarılıyor. Tamamlandığında bilgilendirileceksiniz.',
        ],
    ],
];
