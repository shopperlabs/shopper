...
return [
    ...
    'generate_permissions' => 'Générer des permissions',
    'generate_permissions_description' => 'Saisissez un nom de ressource pour générer automatiquement les 5 permissions CRUD standard et les assigner à ce rôle.',
    'resource_name' => 'Nom de la ressource',
    'permissions_preview' => 'Permissions qui seront créées',
