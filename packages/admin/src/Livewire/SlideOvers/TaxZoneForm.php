 ...
 */
class TaxZoneForm extends SlideOverComponent implements HasActions, HasSchemas, SlideOverForm
{
    ...
    public function store(): void
    {
        ...
        $this->redirectRoute('shopper.settings.taxes', ['zone' => $this->taxZone->id], navigate: true);
    }
}
