<div class="flex flex-col justify-between bg-blue-800 text-center w-16">
    ...
    <div class="flex-shrink-0 flex flex-col items-center space-y-3 pb-4">
        <button class="block p-2 text-base leading-6 font-medium rounded-md text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-900 transition ease-in-out duration-150">
