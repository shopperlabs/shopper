...
@section('content')
    ...
    <div class="mt-4 pb-5 border-b border-gray-200 flex items-center">
        ...
        <h2 class="text-2xl leading-6 text-gray-600 sm:leading-9 sm:truncate">
            Welcome to <span class="font-medium bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-blue-600">Shopper</span> Dashboard
        </h2>
    </div>
        ...
        <div class="bg-gray-50 grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="px-6 py-5 border-t border-gray-200 sm:border-t-0">
                <div class="flex items-center">
                    ...
                    <h4 class="ml-4 text-bas text-gray-900 leading-6 font-medium">Screencasts</h4>
                </div>
            ...
            <div class="px-6 py-5 border-t border-gray-200">
                <div class="flex items-center">
                    ...
                    <h4 class="ml-4 text-base text-gray-900 leading-6 font-medium">Themes</h4>
                </div>
