...
@section('content')
    ...
    <div class="mt-4 pb-5 border-b border-gray-200 dark:border-gray-700 flex items-center">
        ...
        <h2 class="text-2xl leading-6 font-medium text-gray-600 dark:text-white sm:leading-9 sm:truncate">
