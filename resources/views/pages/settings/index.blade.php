...
@section('content')
    ...
    <div class="mt-4 md:flex md:items-center md:justify-between">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold leading-7 text-gray-900 dark:text-white sm:text-3xl sm:leading-9 sm:truncate">{{ __('Settings') }}</h2>
        </div>
    </div>

    <div class="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-5">
        <div class="z-20 relative grid gap-4 sm:gap-x-6 sm:gap-y-4 sm:grid-cols-3">
            <a href="{{ route('shopper.settings.shop') }}" class="p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition ease-in-out duration-200">
            ...
            <a href="{{ route('shopper.settings.users') }}" class="p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition ease-in-out duration-200">
                <div class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-blue-600 text-white sm:h-12 sm:w-12 ">
            ...
            <a href="{{ route('shopper.settings.mails') }}" class="p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition ease-in-out duration-200">
                <div class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-blue-600 text-white sm:h-12 sm:w-12 ">
            ...
            <a href="{{ route('shopper.settings.inventories.index') }}" class="p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition ease-in-out duration-200">
                <div class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-blue-600 text-white sm:h-12 sm:w-12 ">
            ...
            <a href="{{ route('shopper.settings.attributes.index') }}" class="p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition ease-in-out duration-200">
                <div class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-blue-600 text-white sm:h-12 sm:w-12 ">
            ...
            <a x-on:click.prevent="modalDemo = true" href="#" class="p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition ease-in-out duration-200">
                <div class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-blue-600 text-white sm:h-12 sm:w-12 ">
                ...
                <div class="space-y-1">
                    <p class="inline-flex items-center text-base leading-6 font-medium text-gray-900 dark:text-white">
                        {{ __('Shipping and delivery') }}
                        <span class="ml-2.5 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium leading-4 bg-blue-100 text-blue-800">
                            {{ __('Soon') }}
                        </span>
                    </p>
                    <p class="text-sm leading-5 text-gray-500 dark:text-gray-400">
            ...
            <a href="{{ route('shopper.settings.analytics') }}" class="p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition ease-in-out duration-200">
                <div class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-blue-600 text-white sm:h-12 sm:w-12 ">
            ...
            <a href="{{ route('shopper.settings.payments') }}" class="p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition ease-in-out duration-200">
                <div class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-blue-600 text-white sm:h-12 sm:w-12 ">
            ...
            <a href="{{ route('shopper.settings.legal') }}" class="p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition ease-in-out duration-200">
                <div class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-blue-600 text-white sm:h-12 sm:w-12 ">
