...
@section('content')
    ...
    <x:breadcrumb back="shopper.categories.index">
        ...
        <span class="text-gray-500">{{ __('Create category') }}</span>
    </x:breadcrumb>

    <div class="mt-4 md:flex md:items-center md:justify-between">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold leading-7 text-gray-500 sm:text-3xl sm:leading-9 sm:truncate pb-4">{{ __('Create Category') }}</h2>
        </div>
    </div>
