...
@section('content')
    ...
    <x:breadcrumb back="shopper.customers.index">
        ...
        <span class="text-primary-text">{{ __('Create customer') }}</span>
    </x:breadcrumb>

    <div class="mt-6 md:flex md:items-center md:justify-between">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold leading-7 text-primary-text sm:text-3xl sm:leading-9 sm:truncate pb-4">{{ __('Create customer') }}</h2>
        </div>
    </div>
