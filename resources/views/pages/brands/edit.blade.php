...
@section('content')
    ...
    @component('shopper::components.breadcrumb')
        ...
        <span class="text-primary-text">{{ __('Edit brand') }}</span>
    @endcomponent

    <div class="mt-6 md:flex md:items-center md:justify-between">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold leading-7 text-primary-text sm:text-3xl sm:leading-9 sm:truncate pb-4">{{ $brand->name }}</h2>
        </div>
    </div>
        ...
        <div class="mt-8 border-t pt-5 border-gray-200">
            <div class="flex justify-between">
                @include('shopper::components.delete-action', [
                    'title' => __('Delete').' '.$brand->name,
                    'action' => __('Delete brand'),
                    'message' => __("Are you sure you want to delete this brand? All this data will be removed. This action cannot be undone."),
