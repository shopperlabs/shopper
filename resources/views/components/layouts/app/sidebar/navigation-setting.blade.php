<div class="flex-1 overflow-y-auto hide-scroll">
    <h4 class="p-4 text-xs leading-4 text-secondary-900 uppercase tracking-wider font-bold sm:py-5 dark:text-white">{{ __('shopper::layout.account_dropdown.settings') }}</h4>
