...
<div x-data="{ focused: false }">
    ...
    @else
        <div class="w-full">
            <label for="{{ $attributes['id'] }}" :class="{ 'border-blue-200 bg-blue-50': focused }" class="group flex justify-center border-2 border-gray-300 dark:border-gray-700 border-dashed hover:border-blue-200 dark:hover:border-blue-500 hover:bg-blue-50 rounded-md cursor-pointer">
                <div class="px-6 pt-5 pb-6 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-500 group-hover:text-blue-500">
