...
<div x-data="{ focused: false }">
    ...
    @else
        <div class="w-full">
            <label for="{{ $attributes['id'] }}" :class="{ 'border-blue-200 bg-blue-50': focused }" class="group flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed hover:border-blue-200 hover:bg-blue-50 rounded-md cursor-pointer transition duration-150 ease-in-out">
