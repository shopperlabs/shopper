            ...
            <ul class="overflow-hidden flex">
                <li class="relative overflow-hidden lg:flex-1">
                    <div class="border border-gray-200 overflow-hidden border-b-0 rounded-t-md lg:border-0">
                        ...
                        <button
                            x-data
                            @click="document.querySelector('#step-one').scrollIntoView({ behavior: 'smooth', block: 'end'})"
                            type="button"
                                ...
                                <div class="flex-shrink-0">
                                    ...
                                    @else
                                        <div class="w-10 h-10 flex items-center justify-center border-2 border-gray-300 rounded-full">
                                            <p class="text-gray-500">01</p>
                                        </div>
                                    @endif
                                </div>
                                <div class="mt-0.5 min-w-0">
                                    <h3 class="text-xs leading-4 font-semibold uppercase tracking-wide @if($this->stepOneState()) text-gray-900 @else text-gray-500 @endif">{{ __("Business size") }}</h3>
                                    <p class="text-sm leading-5 font-medium text-gray-500">{{ __('Define the size of your store.') }}</p>
                                </div>
                            </div>
                        </button>
                    </div>
                ...
                <li class="relative overflow-hidden lg:flex-1">
                    <div class="border border-gray-200 overflow-hidden lg:border-0">
                        ...
                        <button
                            x-data
                            @click="document.querySelector('#step-two').scrollIntoView({ behavior: 'smooth', block: 'start'})"
                            type="button"
                            class="group text-left"
                        >
                            @if(($email && empty($name)) || ($name && empty($email)))
                            ...
                            <div class="px-6 py-5 flex items-start text-sm leading-5 font-medium space-x-4 lg:pl-9">
                                <div class="flex-shrink-0">
                                    ...
                                    @else
                                        <div class="w-10 h-10 flex items-center justify-center border-2 @if($email || $name) border-blue-600 @else border-gray-300 @endif rounded-full">
                                            <p class="@if($email || $name) text-blue-600 @else text-gray-500 @endif">02</p>
                                        </div>
                                    @endif
                                </div>
                                <div class="mt-0.5 min-w-0">
                                    <h3 class="text-xs leading-4 font-semibold @if(($email && empty($name)) || ($name && empty($email))) text-blue-600 @elseif($this->stepTwoState()) text-gray-900 @else text-gray-500 @endif uppercase tracking-wide">{{ __("Basic information") }}</h3>
                                    <p class="text-sm leading-5 font-medium text-gray-500">{{ __("Provide useful information for your store.") }}</p>
                                </div>
                            </div>
                ...
                <li class="relative overflow-hidden lg:flex-1">
                    <div class="border border-gray-200 overflow-hidden border-t-0 rounded-b-md lg:border-0">
                        ...
                        <button
                            x-data
                            @click="document.querySelector('#step-tree').scrollIntoView({ behavior: 'smooth', block: 'end'})"
                            type="button"
                            class="group text-left"
                        >
                            <div class="absolute top-0 left-0 w-1 h-full bg-transparent group-hover:bg-gray-200 group-focus:bg-gray-200 lg:w-full lg:h-1 lg:bottom-0 lg:top-auto"></div>
                            <div class="py-5 flex items-start text-sm leading-5 font-medium space-x-4 pl-9">
                                ...
                                <div class="mt-0.5 min-w-0">
                                    <h3 class="text-xs leading-4 font-semibold text-gray-500 uppercase tracking-wide">{{ __("Social Links") }} ({{ __("Optional") }})</h3>
                                    <p class="text-sm leading-5 font-medium text-gray-500">{{ __("Links to your social media accounts.") }}</p>
                                </div>
                            </div>
                        </button>
