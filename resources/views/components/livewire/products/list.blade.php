        ...
        <div class="empty-categories relative w-full flex flex-col md:flex-row items-center justify-end relative py-12 md:py-24">
            ...
            <div class="w-full lg:w-1/2 relative z-90">
                <div class="w-full pl-0 lg:pl-20 lg:pt-20 xl:pt-24">
                    <h3 class="text-primary-text font-medium text-xl mb-2">{{ __('Organize your products into products') }}</h3>
                    <p class="text-gray-500 text-lg mb-3">{{ __('Create products to help your customers find products.') }}</p>
            ...
            <div class="px-4 py-4 sm:px-6">
                ...
                <div class="flex rounded-md shadow-sm">
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input id="filter" class="form-input form-input-shopper block w-full rounded-none rounded-l-md pl-10 transition ease-in-out duration-150 sm:text-sm sm:leading-5" placeholder="{{ __('Search products') }}" />
                    </div>
