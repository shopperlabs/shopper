            ...
            <div class="px-4 py-4 sm:px-6">
                ...
                <div class="flex rounded-md shadow-sm">
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input id="filter" class="form-input form-input-shopper block w-full rounded-none rounded-l-md pl-10 transition ease-in-out duration-150 sm:text-sm sm:leading-5" placeholder="{{ __('Search collections') }}" />
                    </div>
