...
<body class="h-full bg-gray-100 text-gray-600 leading-normal font-body transition ease-in-out duration-700 light">
    ...
    <div class="h-screen flex overflow-hidden bg-gray-100" x-data="{ sidebarOpen: false }" @keydown.window.escape="sidebarOpen = false">
        ...
        <div class="flex flex-col w-0 flex-1 overflow-hidden">
            <div class="md:hidden px-3 py-2 bg-white shadow-sm mb-3">
            ...
            <div class="overflow-y-auto">
                <main class="flex-1 relative z-0 min-h-screen -mb-12 focus:outline-none" tabindex="0" x-data x-init="$el.focus()">
