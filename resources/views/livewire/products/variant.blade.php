<div>
                ...
                <div class="overflow-hidden rounded-md shadow">
                    <div class="px-4 py-5 bg-white sm:p-6 dark:bg-secondary-800">
                        <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                            <x-shopper::forms.group label="shopper::layout.forms.label.name" for="name" class="sm:col-span-3" :error="$errors->first('name')" isRequired>
                            ...
                            <div class="sm:col-span-4">
                                <h4 class="block text-sm font-medium leading-5 text-secondary-700 dark:text-secondary-300">{{ __('shopper::messages.images') }}</h4>
                                <div class="mt-1">
    ...
    <div class="mt-10 sm:mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="mt-2 text-lg font-semibold leading-6 text-secondary-900 dark:text-white">{{ __('shopper::messages.pricing') }}</h3>
                </div>
            </div>
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="overflow-hidden rounded-md shadow">
    ...
    <div class="mt-10 sm:mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="mt-2 text-lg font-semibold leading-6 text-secondary-900 dark:text-white">{{ __('shopper::messages.inventory') }}</h3>
                </div>
            </div>
            <div class="mt-5 md:mt-0 md:col-span-2">
                    ...
                    <div class="divide-y divide-secondary-200 dark:divide-secondary-700">
                        <div class="px-4 py-5 sm:p-6">
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                <x-shopper::forms.group label="shopper::layout.forms.label.sku" for="sku" class="sm:col-span-1" :error="$errors->first('sku')">
                                    <x-shopper::forms.input wire:model.defer="sku" id="sku" type="text" autocomplete="off" />
                                </x-shopper::forms.group>
                                <x-shopper::forms.group label="shopper::layout.forms.label.barcode" for="barcode" class="sm:col-span-1" :error="$errors->first('barcode')">
                            ...
                            <div class="grid gap-4 pt-4 sm:grid-cols-2 sm:gap-6 sm:pt-5">
                                <x-shopper::forms.group label="shopper::layout.forms.label.safety_stock" for="security_stock" class="sm:col-span-1" helpText="shopper::pages/products.safety_security_help_text">
                            ...
                            <div class="mt-4 divide-y divide-secondary-200 dark:divide-secondary-700">
                                <div class="grid grid-cols-3 py-4">
                                    <div class="col-span-2">
                                        <span class="text-xs font-semibold leading-5 tracking-wider uppercase text-secondary-500 dark:text-secondary-400">{{ __('shopper::pages/products.inventory_name') }}</span>
                                    </div>
                                    <div class="flex justify-end col-span-1 pl-4 text-right">
                                        <span class="text-xs font-semibold leading-5 tracking-wider uppercase text-secondary-500 dark:text-secondary-400">{{ __('shopper::messages.available') }}</span>
                                    </div>
                                </div>
