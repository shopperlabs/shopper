        ...
        <div class="h-96 overflow-y-scroll">
            <div class="overflow-hidden">
                @if($inventories->isNotEmpty())
                    <div class="p-4 sm:px-5 relative flex items-center justify-between border-b border-secondary-200 dark:border-secondary-700">
                ...
                @else
                    <div class="flex flex-col">
                        ...
                        <div class="px-4 py-3 flex items-center justify-between border-t border-secondary-200 sm:px-6 dark:border-secondary-700">
