        ...
        <div class="bg-white">
            ...
            <div class="py-2 px-4 sm:px-6 border-t border-gray-100">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input id="search" wire:model.debounce.300ms="search" autocomplete="off" class="form-input block w-full pl-10 pr-6 sm:text-sm sm:leading-5" placeholder="{{ __("Search product by name") }}" />
