            ...
            >
                <div>
                    <div class="sm:flex sm:items-start px-4 sm:px-6 py-4">
                        <div class="text-center sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-secondary-700 dark:text-secondary-300">
                    ...
                    <div class="py-2 px-4 sm:px-6 border-t border-secondary-100 dark:border-secondary-700">
                        <label for="search" class="sr-only">{{ __('shopper::layout.forms.label.search') }}</label>
                ...
                <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <span class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                        <x-shopper::buttons.default @click="modal = false;" type="button">
        ...
        >
            ...
            >
                <div>
                    <div class="sm:flex sm:items-start px-4 sm:px-6 py-4">
                        <div class="text-center sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-secondary-700 dark:text-secondary-300">{{ __('shopper::pages/discounts.modals.add_customers') }}</h3>
                        </div>
                    </div>
                    <div class="py-2 px-4 sm:px-6 border-t border-secondary-100 dark:border-secondary-700">
                        <label for="search" class="sr-only">{{ __('shopper::layout.forms.label.search') }}</label>
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <x-shopper::forms.input
                                id="search"
                                type="search"
                                wire:model.lazy="searchCustomer"
                                autocomplete="off"
                                class="pl-10 pr-6"
                            ...
                            <label for="customer_{{ $customer->id }}" class="flex items-center py-3 cursor-pointer hover:bg-secondary-50 px-4 sm:px-6 focus:bg-secondary-50 dark:hover:bg-secondary-700 dark:focus:bg-secondary-700">
                                <span class="mr-4">
                                    <x-shopper::forms.checkbox
                                        ...
                                        wire:model.lazy="selectedCustomers"
                                        value="{{ $customer->id }}"
                                    />
                                </span>
                ...
                <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <span class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                        <x-shopper::buttons.default @click="show = false;" type="button">
                            {{ __('shopper::layout.forms.actions.cancel') }}
                        </x-shopper::buttons.default>
                    </span>
                </div>
