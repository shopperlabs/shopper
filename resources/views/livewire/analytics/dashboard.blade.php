                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3 flex-1 md:flex md:justify-between">
                            <p class="text-sm text-blue-700 text-left">
                                {{ __('To see Google Analytics Data, you’ll need to get some credentials to use') }} <a href="https://console.developers.google.com/apis" target="_blank" class="underline font-medium text-blue-800">Google API’s</a>. {{ __('This section use Spatie/analytics package. To finally display analytics chart you have to update your analytics setting') }}
                                <a href="{{ route('shopper.settings.analytics') }}" class="underline text-blue-800 font-medium">{{ __('here') }}</a>.
                            </p>
                        </div>
                    </div>
                </div>
