...
<div>
    <x:shopper-breadcrumb back="shopper.settings.inventories.index">
        ...
        <a href="{{ route('shopper.settings.inventories.index') }}" class="text-gray-500 hover:text-gray-700 focus:outline-none focus:underline transition duration-150 ease-in-out">{{ __('Products') }}</a>
