                                                ...
                                                <div class="mt-2 sm:flex sm:justify-between">
                                                    <div class="sm:flex sm:space-x-4">
                                                        <div class="flex items-center text-sm leading-5 text-secondary-500 dark:text-secondary-400">
                                                            <x-heroicon-s-flag class="flex-shrink-0 mr-1.5 h-5 w-5 text-secondary-400 " />
                                                        ...
                                                        <div class="mt-2 flex items-center text-sm leading-5 text-secondary-500 sm:mt-0 dark:text-secondary-400">
                                                            <x-heroicon-s-location-marker class="flex-shrink-0 mr-1.5 h-5 w-5 text-secondary-400 dark:text-secondary-500" />
                                                            {{ $inventory->city }}
                                                        </div>
                                                        <div class="mt-2 flex items-center text-sm leading-5 text-secondary-500 sm:mt-0">
                                                            <x-heroicon-s-phone class="flex-shrink-0 mr-1.5 h-5 w-5 text-secondary-400 dark:text-secondary-500" />
                                                            {{ $inventory->phone_number ?? __('Number not set') }}
                                                        </div>
                                                    </div>
                                                    <div class="mt-2 flex items-center text-sm leading-5 text-secondary-500 sm:mt-0 dark:text-secondary-400">
                                                        <x-heroicon-s-calendar class="flex-shrink-0 mr-1.5 h-5 w-5 text-secondary-400 dark:text-secondary-500" />
                                                        <span>
                                                            {{ __('Added on') }}
