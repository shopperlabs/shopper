                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-2 flex items-center">
                                ...
                                @if($credentials_json)
                                    <a class="ml-4 text-sm leading-5 text-gray-500 underline hover:text-gray-400" href="{{ \Illuminate\Support\Facades\Storage::url('analytics/service-account-credentials.json') }}">{{ __('View json.') }}</a>
                                @endif
                                @if(! $json_file && ! $credentials_json)
                                    <span class="ml-4 text-sm leading-5 text-gray-400">
