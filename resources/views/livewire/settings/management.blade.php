        ...
        <div class="bg-white rounded-lg p-4 sm:p-6 shadow-md overflow-hidden">
            ...
            <div class="mt-8 grid gap-4 sm:grid-cols-2 sm:gap-6 md:grid-cols-3 md:gap-8">
                @foreach($roles as $role)
                    <a href="#" class="group block p-4 border border-gray-200 rounded-md overflow-hidden hover:shadow-md focus:border-gray-300 focus:outline-none transition duration-200 ease-in-out">
