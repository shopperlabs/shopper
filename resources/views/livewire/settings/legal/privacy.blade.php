    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-semibold leading-6 text-gray-900">{{ __("Privacy policy") }}</h3>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            <x-shopper-input.group label="Content" for="content">
                                <x-shopper-input.rich-text wire:model="privacyContent" id="content" :initial-value="$this->privacyContent" />
