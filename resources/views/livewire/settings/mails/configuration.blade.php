<div class="sm:px-8 mt-4 max-w-5xl mx-auto">
    <div class="space-y-8 divide-y divide-secondary-200 dark:divide-secondary-700">
        <div>
            ...
            <div class="mt-6 grid gap-4 grid-cols-6 sm:gap-6">
                <div class="col-span-6 sm:col-span-3">
                    <x-shopper::forms.group for="mail_from_name" :label="__('Sender name')" :error="$errors->first('mail_from_name')" isRequired>
                        <x-shopper::forms.input type='text' wire:model='mail_from_name' autocomplete='off' id='mail_from_name' />
                    </x-shopper::forms.group>
                </div>

                <div class="col-span-6 sm:col-span-3">
                    <x-shopper::forms.group for="mail_from_address" :label="__('Sender email')" :error="$errors->first('mail_from_address')" isRequired>
                        <x-shopper::forms.input type='text' wire:model='mail_from_address' autocomplete='off' id='mail_from_address' />
                    </x-shopper::forms.group>
                </div>

                <div class="col-span-6 sm:col-span-3">
                    <x-shopper::forms.group for="mail_username" :label="__('Username')">
        ...
        <div class="pt-8">
            ...
            <div class="mt-6 grid gap-4 grid-cols-6 sm:gap-6">
                <x-shopper::forms.group for="mail_mailer" :label="__('Mail method')" class="col-span-6 sm:col-span-3">
                ...
                <x-shopper::forms.group for="mail_host" :label="__('Mail host')" class="col-span-6 sm:col-span-3">
                    <x-shopper::forms.input type='text' wire:model='mail_host' autocomplete='off' id='mail_host' />
                </x-shopper::forms.group>

                <x-shopper::forms.group for="mail_port" :label="__('Mail port')" class="col-span-6 sm:col-span-3">
                    <x-shopper::forms.input type='text' wire:model='mail_port' autocomplete='off' id='mail_port' />
                </x-shopper::forms.group>

                <x-shopper::forms.group for="mail_encryption" :label="__('Encryption protocol')" class="col-span-6 sm:col-span-3">
