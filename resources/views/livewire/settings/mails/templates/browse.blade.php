                                    ...
                                    @forelse($templates->all() as $template)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                ...
                                                <button wire:click="openRemovedModal('{{ $template->template_name }}', '{{ $template->template_slug }}')" type="button" class="inline-flex items-center p-2 rounded-full hover:bg-gray-50 active:bg-gray-100 focus:bg-gray-100 text-gray-500 text-sm leading-5 hover:text-gray-400 focus:outline-none">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="bg-white rounded-lg px-4 pt-5 pb-4 text-left">
            ...
            <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-headline">
                        {{ __("Delete :template Template", ['template' => $itemName]) }}
                    </h3>
                    <div class="mt-2">
            ...
            <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                    <x-shopper-danger-button wire:click="removedTemplate" type="button">
