                                    ...
                                    @forelse($mailables->all() as $mailable)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                ...
                                                <button wire:click="$emit('openModal', 'shopper-modals.delete-mailable', {{ json_encode(['item' => $mailable['name']]) }})" type="button" class="inline-flex items-center p-2 rounded-full hover:bg-gray-50 text-gray-500 text-sm leading-5 hover:text-gray-400 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700">
                                        ...
                                        <tr>
                                            <td colspan="4" class="px-6 py-3 text-right text-xs font-medium">
                                                <div class="py-10 flex flex-col items-center justify-center">
                                                    ...
                                                    <span class="mt-4 text-sm text-gray-500 font-medium dark:text-gray-400">{{ __("We didn't find anything - just empty space.") }}</span>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
