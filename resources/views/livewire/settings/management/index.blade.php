<div>
    ...
    <div class="mt-8 pb-10">
        <div class="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow-md overflow-hidden">
            ...
            <p class="mt-3 text-base leading-6 text-gray-500 dark:text-gray-400">
            ...
            <div class="mt-8 grid gap-4 sm:grid-cols-2 sm:gap-6 md:grid-cols-3 md:gap-8">
                @foreach($roles as $role)
                    <a href="{{ route('shopper.settings.user.role', $role) }}" class="group flex flex-col justify-between border border-gray-200 dark:border-gray-700 p-4 rounded-md overflow-hidden hover:shadow-md">
                        <div class="flex items-center justify-between">
                            <span class="text-xs leading-4 text-gray-400 dark:text-gray-500 font-semibold uppercase tracking-wider">{{ $role->users->count() }} {{ str_plural(__('Account'), $role->users->count()) }}</span>
        ...
        <div class="mt-10 bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow-md">
            <div class="pb-6 border-b border-gray-200 space-y-3 sm:flex sm:items-center sm:justify-between sm:space-x-4 sm:space-y-0  dark:border-gray-700">
                <div class="flex-1 min-w-0 max-w-2xl">
                    <h2 class="text-lg leading-6 font-medium text-gray-900 dark:text-white">{{ __('Administrators accounts') }}</h2>
                    <p class="mt-3 text-base leading-6 text-gray-500 dark:text-gray-400">
            ...
            <div class="mt-6 border border-gray-200 rounded-md dark:border-gray-700">
                <div class="overflow-x-auto">
                    <div class="align-middle inline-block min-w-full">
                        <table class="min-w-full">
                            ...
                            <tbody class="divide-y divide-gray-100 bg-white dark:bg-gray-800 dark:divide-gray-700" x-max="1">
                    ...
                    <div class="flex items-center justify-between px-4 py-3 sm:px-6 border-t border-gray-200 rounded-b-md bg-white dark:bg-gray-800 dark:border-gray-700">
