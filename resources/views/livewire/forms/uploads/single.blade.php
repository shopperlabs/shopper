<div x-data="{ focused: false }">
    ...
    @else
        <label for="{{ $inputId }}" :class="{ 'border-blue-200 bg-blue-50 dark:bg-gray-800': focused }" class="mt-2 group flex justify-center border-2 border-gray-300 dark:border-gray-600 border-dashed hover:border-blue-200 dark:hover:border-gray-600 hover:bg-blue-50 dark:hover:bg-gray-700 rounded-md cursor-pointer overflow-hidden">
