            ...
            <aside class="sticky top-6 space-y-5">
                <div class="bg-white rounded-md shadow overflow-hidden divide-y divide-gray-200">
                    ...
                    <div class="p-4 sm:p-5">
                        ...
                        @if($brand->files->isNotEmpty())
                            <div class="mt-2">
                                <h6 class="block text-sm leading-5 font-medium text-gray-500">{{ __("Current Image") }}</h6>
                                <div class="mt-2 flex-shrink-0 w-10 h-10 overflow-hidden rounded-md shadow">
                                    <img class="h-full w-full object-cover" src="{{ $brand->files->first()->file_path }}" alt="">
                                </div>
                            </div>
                        @endif
                    </div>
