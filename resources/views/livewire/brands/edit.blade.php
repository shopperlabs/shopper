                    ...
                    <div class="mt-4">
                        ...
                        @else
                            <div class="flex flex-col">
                                ...
                                <span class="mt-1 text-green-600 text-sm leading-5 dark:text-green-500">{{ env('APP_URL') }}/brands/{{ $brand->slug }}</span>
            ...
            <aside class="sticky top-6 space-y-5">
                <div class="bg-white dark:bg-gray-800 rounded-md shadow overflow-hidden divide-y divide-gray-200 dark:divide-gray-700">
                    <div class="p-4 sm:p-5">
                        ...
                        <div class="mt-1">
                            <livewire:shopper-forms.uploads.single-upload :media="$brand->getFirstMedia(config('shopper.system.storage.disks.uploads'))" />
                        </div>
                    </div>
                </div>
            </aside>
