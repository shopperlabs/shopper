                ...
                <div class="bg-white rounded-md shadow overflow-hidden divide-y divide-gray-200">
                    ...
                    <div class="p-4 sm:p-5">
                        ...
                        @if($this->category->files->isNotEmpty())
                            <div class="mt-2 p-2 bg-gray-50 rounded-sm border border-dashed border-gray-200 flex items-center justify-between">
                                <div class="flex-shrink-0 w-10 h-10 overflow-hidden rounded-md shadow">
                                    <img class="h-full w-full object-cover" src="{{ $this->category->files->first()->file_path }}" alt="">
                                </div>
                                <button type="button" class="ml-4 inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs leading-4 font-medium rounded text-red-700 bg-red-100 hover:bg-red-50 focus:outline-none focus:border-red-300 focus:shadow-outline-red active:bg-red-200 transition ease-in-out duration-150">
