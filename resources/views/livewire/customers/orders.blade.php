            ...
            <div class="p-4 sm:px-5 sm:py-6 sm:grid sm:grid-cols-4 sm:gap-4">
                <div class="sm:col-span-2">
                    <div class="flex items-center space-x-3">
                        <h4 class="text-lg font-bold text-secondary-900 leading-6 dark:text-white">{{ __('Order items') }}</h4>
                ...
                <div class="mt-4 sm:mt-0">
                    <h5 class="text-base leading-6 font-medium text-secondary-900 dark:text-white">{{ __('Payment method') }}</h5>
                ...
                <div class="mt-4 sm:mt-0">
                    <h5 class="text-base leading-6 font-medium text-secondary-900 dark:text-white">{{ __('Shipping method') }}</h5>
                    <div class="mt-2 flex items-center">
                        ...
                        @else
                            <p class="text-sm font-medium text-secondary-500 dark:text-secondary-400">{{ __('No shipping method.') }}</p>
                        @endif
                    </div>
                </div>
            </div>
    ...
    @empty
        <div class="bg-white rounded-lg shadow-md overflow-hidden py-10 sm:py-12 flex items-center justify-center dark:bg-secondary-800">
            <div class="flex justify-center items-center space-x-2">
                ...
                <span class="font-medium py-8 text-secondary-400 text-xl">{{ __('No orders found') }}...</span>
            </div>
        </div>
    @endforelse
