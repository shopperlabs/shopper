...
const ShopInitialization = () => {
  ...
  const onSubmit = () => {
    ...
    axios.post('/api/shop/initialization', submittedValues)
      .then(() => {
        setComplete(true);
        validateStep3();
      })
      ...
      <div className="w-full md:w-80 bg-white shadow-md flex flex-col justify-between pt-12 pb-6 md:pb-0">
        <div className="px-6">
          <div className="flex items-center justify-between">
            <img className="h-12 w-auto" src={require("@/assets/svg/shopper.svg")} alt="Laravel Shopper" />
            <a onClick={logout} href="#" className="leading-6 font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 md:hidden flex items-center bg-gray-50 shadow-md rounded-md px-3 py-2 transition ease-in-out duration-150">
              {user.full_name}
          ...
          <div className="mt-6">
            <h4 className="font-medium text-lg text-gray-800 mb-3">Shop Setup</h4>
            <Steps
        ...
        <div className="hidden md:flex flex-shrink-0 flex border-t border-gray-200 p-4 bg-gray-50">
          <div className="flex-shrink-0 group block focus:outline-none">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-base leading-6 font-medium text-gray-700 group-hover:text-gray-900">{user.full_name}</p>
                <a onClick={logout} href="#" className="text-sm leading-5 font-medium text-gray-500 group-hover:text-gray-700 group-focus:underline transition ease-in-out duration-150">
                  Logout
                </a>
              </div>
            </div>
