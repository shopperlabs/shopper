...
const FilePondUpload = () => {
  ...
  const token: any = (document.querySelector(
              ...
              {images.length === 0 && (
                <div className="py-10 w-full">
                  <div className="text-center">
                    ...
                    <h2 className="text-base mt-4 leading-5 font-medium text-gray-700">
                      No images.
                    </h2>
                  </div>
                </div>
                ...
                <div className="bg-white px-4 py-4 sm:px-6 shadow-sm rounded-md overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-6 lg:grid-cols-4 xl:grid-cols-6 py-4">
                    {images.map((image: ImageType) => (
                      <div
                        key={image.id}
                        className="relative group border border-gray-200 flex flex-col bg-white rounded-md overflow-hidden hover:border-gray-300"
                      >
