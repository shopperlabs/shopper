    ...
    <div className="relative w-full md:w-4/5 mx-auto pt-4 pb-10 md:pt-12">
      <form onSubmit={onSubmit}>
        <div className="mb-10">
          ...
          <p>
            Information about your different accounts on social networks. Users
            will be able to contact you directly on your official pages.
          </p>
        </div>
        <div className="step-content step-tree md:flex h-full items-center">
          <div className="p-8 bg-white rounded-md shadow-md w-full flex items-center">
            ...
            <div className="hidden md:flex md:w-1/2">
              <img
                className="mx-auto"
                src={require("@/assets/svg/social_sharing.svg")}
                alt="shop"
                width="60%"
              />
            </div>
