...
describe(User::class, function (): void {
    ...
    it('grants dashboard access to admin, manager, and holders of the `access_dashboard` permission', function (): void {
        ...
        Permission::query()->firstOrCreate(['name' => 'access_dashboard']);
        $staff->givePermissionTo('access_dashboard');
    ...
    it('denies dashboard access to customers without the `access_dashboard` permission', function (): void {
