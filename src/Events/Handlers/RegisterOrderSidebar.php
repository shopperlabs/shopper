    ...
    public function extendWith(Menu $menu)
    {
        $menu->group(__('Shop'), function (Group $group) {
            ...
            $group->item(__('Shipping'), function (Item $item) {
                ...
                $item->authorize(true);
                $item->icon('
                    <svg class="flex-shrink-0 -ml-1 mr-3 h-5 w-5 text-gray-500 group-hover:text-gray-500 group-focus:text-gray-600 transition ease-in-out duration-150" stroke="none" fill="currentColor" viewBox="0 0 24 24">
